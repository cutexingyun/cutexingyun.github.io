oS.Init({
    PName: [oSunFlower, oPumpkinHead , oPotatoMine ,oGatlingPea , oGloomShroom ,oSquash ,oTorchwood,oChomper,oTallNut,oRepeater,oGarlic,oSpikeweed], // 植物名称数组
    ZName: [oZombiejump,oPoleVaultingZombie,oNewspaperZombie2,oNewspaperZombie1], // 僵尸名称数组
