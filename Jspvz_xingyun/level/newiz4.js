// 初始化游戏设置
oS.Init({
    PName: [oPotatoMine,oSpikeweed,oSunFlower,oRepeater,oTorchwood,oPumpkinHead,oHypnoShroom,oSquash,oGatlingPea,oGarlic], // 植物名称数组
    ZName: [oJalapenoZombie,oScreenDoorZombie], // 僵尸名称数组
