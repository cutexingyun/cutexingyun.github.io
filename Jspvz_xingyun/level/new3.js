oS.Init(
    {
      PName: [oIceFumeShroom,oIceShroom,oSnowPea,oWinterMelon1,oSnowPea1,oGatlingPea1,oSunFlower1,oPuffShroom1,oHypnoShroom1],
      ZName: [
        oZombie,
        oZombie2,
        oZombie3,
    ...
    },
    {
      ...
      FlagToEnd: function () {
        NewEle(
          "DivA",
          "div",
          "position:absolute;width:900px;height:600px;background:#FFF;filter:alpha(opacity=0);opacity:0;z-index:160",
          0,
          EDAll
        );
        NewImg(
    ...
    },
    {
      ...
      ChosePlant: function (a, b) {
        ...
        var f = ArCard[oS.ChoseCard],
          e =
            a.clientX - EDAlloffsetLeft + EBody.scrollLeft || EElement.scrollLeft,
      ...
      GrowPlant: function (l, c, b, f, a) {
        ...
        k.CanGrow(l, f, a) &&
          (function () {
            PlayAudio(
              h != 2 ? "plant" + Math.floor(1 + Math.random() * 2) : "plant_water"
            );
