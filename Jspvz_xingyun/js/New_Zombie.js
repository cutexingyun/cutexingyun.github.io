  ...
  oZombiejump = InheritO(oPoleVaultingZombie, {
        ...
        JudgeAttack: function() {
            ...
            for (f = c - 2; f <= c; f++) {
                ...
                for (a = 2; a > -1;
                    (p = h[d + f + "_" + a--]) && (p.EName != "oBrains" ? p.AttackedRX >= e && p.AttackedLX < b && p.canEat && (a = -1, (p.Stature > 0?g.JudgeAttack = CZombies.prototype.JudgeAttack:1), g.NormalAttack(g.id, p.id, p.AttackedLX)) : p.AttackedRX >= b && p.AttackedLX < b && (a = -1, g.JudgeAttack = CZombies.prototype.JudgeAttack, (g.NormalAttack = CZombies.prototype.NormalAttack)(g.id, p.id)))) {}
            }
        },
        ...
        NormalAttack: function(d, b, g) {
            ...
            oSym.addTask(100, function(m, j, i, l, n) {
                ...
                h && ((k = $P[j]) && k.Stature > 0 ? (h.AttackedRX = (h.X = (h.AttackedLX = h.ZX = q = k.AttackedRX) - h.beAttackedPointL) + h.beAttackedPointR, SetStyle(i, {
                    ...
                    var u = $Z[s],
                        t;
                    u && (u.isAttacking = 0, u.Altitude =1,v.src = u.PicArr[u.NormalGif])
                }, [m, n])))
            }, [d, b, a, c, e])
        }
    }),
