var $User = (function () {
    ...
    e
      ? (document.execCommand("BackgroundImageCache", false, true),
        (ShadowPNG = "images/interface/plantshadow8.gif"))
    ...
    return {
      ...
      Server: {
        List: [
          ["1号(电信)", "http://pvz1.jspvz.com/", "NaN"],
          ["2号(联通)", "http://pvz2.jspvz.com/", "NaN"],
        ],
        SpeedURL: "",
        DataURL: "",
        SpeedInx: 0,
  ...
  oS = {
    ...
    LoadTips: function () {
      ...
      b.innerHTML =
        '<span style="font-weight:bold">游戏小贴士:</span><span>' +
    ...
    LoadProgress: function (r, l, a, t, b) {
      ...
      y.setAttribute(
        "title",
        "如果长时间没有加载完毕或者不想再等待预读可以尝试点击跳过预读直接进入游戏"
      );
    ...
    CheckImg: function (b, a) {
      ...
      $("sFlagMeterTitleF").innerHTML =
        '<span style="cursor:pointer;font-family:Yahei Mono;color:#fff">LOADING...(<span style="cursor:pointer;color:#ff0">直接进入游戏</span>):(' +
        c.AccessNum +
        "/" +
        c.PicNum +
        ")</span>";
      ...
      if (c.AccessNum == c.PicNum) {
        ...
        if (c.MustAllReady) {
          $("sFlagMeterTitleF").innerHTML =
            '<span style="cursor:pointer;font-family:Yahei Mono;color:#fff">图片载入完毕！(<span id="ADTimer" style="cursor:pointer;color:#005"></span>)</span>';
          c.LoadReady(c);
        }
      }
    },
    LoadReady: function (f) {
        ...
        if (oS.MustAllReady && oS.DisplayAD) {
          ...
          if (b > 0) {
            ...
            (function (g) {
              ...
              h &&
                ($("ADTimer").innerHTML =
                  '<span style="text-decoration:underline;color:#ff0">倒计时' +
                  g +
                  "秒,跳过广告</span>");
      ...
      SetStyle($("tGround"), a);
      oS.backgroundImage == "images/interface/background4.jpg" &&
          ...
          ? oSym.addTask(
              ...
              [
                NewEle(
                  ...
                  {
                    innerHTML:
                      (Math.floor(g.UserAuthority) == "255"
      ...
      (EDAll.scrollLeft += 25) < 500
        ...
        : ((EDAll.scrollLeft = 500),
          ...
          oS.CanSelectCard
            ...
            : (AutoSelectCard(), oSym.addTask(200, oS.ScrollBack, [LetsGO])));
    },
    ScrollBack: function (a) {
      ...
      (function (c) {
        ...
        (b -= 25) > 0
          ? ((EDAll.scrollLeft = b), oSym.addTask(2, arguments.callee, [c]))
  ...
  oCoord = {
    ...
    2: function () {
      ...
      oS.GifHTML =
        '<img style="position:absolute;left:253px;top:278px" src="images/interface/background' +
        (oS.DKind ? 3 : 4) +
        '_2.gif">';
  ...
  oP = {
    Init: function (a) {
      ...
      a && a.FlagNum
        ? ((r.FlagHeadStep = 140 / (a.FlagNum - 1)),
          (r.MonPrgs = function () {
            var u = oP,
              j,
              i = u.FlagZombies,
          ...
          oSym.addTask(
            ...
            function () {
              [
                function () {
                  PlayAudio(
                    ["groan1", "groan2"][Math.floor(Math.random() * 2)]
                  );
                },
                function () {
                  PlayAudio(
                    ["groan3", "groan4"][Math.floor(Math.random() * 2)]
                  );
                },
                function () {
                  PlayAudio(
                    ["groan5", "groan6"][Math.floor(Math.random() * 2)]
                  );
                },
                function () {
                  PlayAudio("groan1");
      ...
      var h = oP,
        ...
        b = !f
          ...
          : ((f.style.top = "5px"),
            ...
            30);
      while (d > 0) {
        d -= (c[a++] = g[Math.floor(Math.random() * $SEql(d, e))]).prototype
          .Lvl;
      }
      h.NumZombies += a;
  ...
  GroundOnmousedown = function (i) {
    i = window.event || i;
    var a =
        i.clientX - EDAlloffsetLeft + EBody.scrollLeft || EElement.scrollLeft,
    ...
    switch (oS.Chose) {
      ...
      case -2:
        WhichMouseButton(i) < 2
          ? (PlayAudio("plant2"), jianongpao(f, b))
          : (PlayAudio("tap"), CancelPao());
    }
  },
  ...
  GroundOnmousemove1 = function (j) {
    j = window.event || j;
    var d =
        j.clientX - EDAlloffsetLeft + EBody.scrollLeft || EElement.scrollLeft,
  ...
  GroundOnmousemove2 = function (k) {
    k = window.event || k;
    var d =
        k.clientX - EDAlloffsetLeft + EBody.scrollLeft || EElement.scrollLeft,
  ...
  jianongpao = function (R, C) {
    ...
    oSym.addTask(400, function myc() {
      NewImg(
        "tPat",
        "images/Plants/CobCannon/BulletHit.gif" + "?" + Date.now(),
        "left:" +
          (GetX(C) - 130) +
          "px;top:" +
          (GetY(R) - 470) +
  ...
  Chosepao = function (a, R, C) {
    ...
    WhichMouseButton(a) < 2 &&
      ...
      (paoattack[1] = C),
      (oS.Chose = -2),
      (GroundOnmousemove = GroundOnmousemove3),
      StopBubble(a));
  },
    ...
    while (b--) {
      ...
      switch (a) {
        ...
        case 7.5:
          d.CDReady = 1;
          e <= oS.SunNum &&
            ((d.SunReady = 1), ($(d.DID).childNodes[0].style.top = "0"));
          break;
        case 30:
          DoCoolTimer(b, 20);
          break;
  ...
  ChosePlant = function (h, d) {
    ...
    h = window.event || h;
    var b =
        h.clientX - EDAlloffsetLeft + EBody.scrollLeft || EElement.scrollLeft,
  ...
  GrowPlant = function (l, d, c, e, b) {
    // 推荐换成如下种植函数，可以适配未重写关的 GrowPlant，还支持流星雨卡槽
    var j = oS.ChoseCard,
      f = ArCard[j],
      h = f.PName,
      k = h.prototype,
    ...
    k.CanGrow(l, e, b) &&
      (PlayAudio(
        g != 2 ? "plant" + Math.floor(1 + Math.random() * 2) : "plant_water"
      ),
      s
  ...
  AppearCard = function (h, f, e, a, t) {
    ...
    if (a)
      (d = 0),
        oSym.addTask(1, MoveDropCard, [g, f, t]); // 从天而降，反之抛物线掉落
    else
      (d = f - 15 - 20),
        (c += ";top:" + d + "px"),
          ...
          function (q, p, n, j, l, k, m, i) {
            if (ArCard[q] && $(q)) {
              ...
              m > 0 &&
                ...
                oSym.addTask(i, arguments.callee, [q, p, n, j, l, k, m, ++i]));
            }
          },
          [
            g,
    ...
    (function (k, l, n, s, m, r, j, q, p) {
      (m -= q) > n
        ...
        : (SetStyle($(k), {
          ...
          innerText(
            ESSunNum,
            (oS.SunNum = Math.min(oS.SunNum + l.N, oS.MaxSunNum))
          ),
          MonitorCard(),
          delete ArSun[k],
  ...
  GameOver = function (a) {
    ...
    !a
      ...
      : (PlayAudio("losemusic", false),
        SetHidden($("dLoginDataHTML")),
        ($("dMsgFailed").innerHTML =
          a + '<p><p><span style="color:#10AE08">点击重新开始</span>'),
  ...
  ShowLoginDiv = function () {
    $User.isAuthorWebsite
      ? (PlayAudio("tap"), SetBlock($("dShowMsgLogin")))
      : GotoAuthorWebsite("登录和保存功能");
  },
  GameLogin = function (h) {
    if (!CheckLogin(h)) {
      return alert(
        "用户名只能输入3-10个中文、字母、数字、下划线\n\n密码只能输入6-20个字母+数字"
      );
    }
    var a,
      g,
  ...
  CheckLogin = function (inx) {
    var c = $("txtName").value,
      ...
      d = !inx
        ? /^\w{3,20}$/
        : /^(?=.*\d)(?=.*[a-zA-Z])[\da-zA-Z~!@#$%^&_*]{6,20}$/; //密码为6-20位，必须有数字+字母，可以有特殊字符
  ...
  LoadLvl = function (e, c) {
    ...
    oS.CenterContent &&
      ((e == 0 && b) || e != 0) &&
      ((oS.DisplayAD = false), SetNone($("dAdFlash"), $("dAD2")));
    SetBlock($("dLvlLink"));
    e = e || 0;
  ...
  ShowRiddle1 = function () {
    $User.isAuthorWebsite
      ? (PlayAudio("gravebutton"),
        SetNone($("dRiddleInx")),
        SetBlock($("dRiddle1")),
        ($("dRiddleTitle").innerHTML = "益智模式对战版"))
      : GotoAuthorWebsite("益智模式对战的功能");
  },
  ReturnRiddleInx = function () {
    PlayAudio("tap");
    SetBlock($("dRiddleInx"));
    SetNone($("dRiddle0"), $("dRiddle1"));
    $("dRiddleSmallContainer").className =
      "TitleSmallContainer  Almanac_IndexBack";
...
($SSml = function (d, c, a) {
  ...
  (ShowAD = function (b, a) {
    document.write(
      (oS.CenterContent = '<div id="dAdFlash">' + oS.adFlash + "</div>")
    );
    oS.CenterContent = 1;
    ...
    : function (a) {
        !oS.Silence &&
          ($("oEmbed").innerHTML =
            ...
            a +
            '.swf"><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" /><embed width="0" height="0" src="music/' +
            a +
 ...
 var titles = ["Jspvz_xingyun:欢迎游玩", "Jspvz_xingyun：荇芸吖", "Jspvz_xingyun：这是基于jspvz的改版","Jspvz_xingyun：基于jspvz的游戏","Jspvz_xingyun：为什么没人玩！","Jspvz_xingyun：这游戏很好玩！","Jspvz_xingyun:千万别种向日葵，不然你就会发现阳光变多了！","Jspvz_xingyun:过不了？"];
