...
oS = {
	...
	Init: function(e, g, b, d) {
		...
		! this.PicArr && (this.PicArr = []); ! this.PName && (this.PName = []); ! this.ZName && (this.ZName = []); ! this.backgroundImage && (this.backgroundImage = "images/interface/background1.jpg"); ! this.LF && (this.LF = [0, 1, 1, 1, 1, 1]); ! this.ZF && (this.ZF = this.LF); ! this.LargeWaveFlag && (this.LargeWaveFlag = {}); ! this.StartGameMusic && (this.StartGameMusic = "UraniwaNi");
	...
	LoadTips: function() {
		...
		a = ["本游戏自带调速功能,在游戏选项里哦,别再抱怨节奏慢了!!", "本游戏有选关功能,请到游戏选项里选择!", "应该没有人会去找作者吧？！应该吧……", "不会关闭声音?请到游戏选项里勾选静音功能!", "游戏选项里面有“自动拾取阳光”的功能!", "不会玩?点左下角“点击开始”,再点击右边墓碑上的选项开始玩,初次玩就点“开始冒险吧”", "这游戏是不是给3岁小孩玩的?这么幼稚!亲爱的,如果你玩过原版植物僵尸就不会这么认为了", "这是山寨版?是的,这是基于jspvz的改版", "本作者没有实力所以更新很慢!", "初次玩的朋友,请从第一关开始玩起,自然会有教学功能教你一步一步玩下去", "为啥看不到阳光或者僵尸?检查一下你浏览器里的广告杀手功能,也许是它在搞鬼!", "游戏毫无难度?在目前进度下,可以尝试着使用调速功能玩更快的速度", "", "为啥这么卡?如果你是IE6-8的用户,请使用IE9,Chrome,Firefox,Opera等更好的浏览器!", "如果你支持我,非常感谢", "这是用什么语言写的?javascript,一个简单而又神奇的语言,纯的,JS!"];
...
InitHandBookPCard = function() {
	...
	var d = "",
	g, f, e = [oPeashooter, oSunFlower, oCherryBomb, oWallNut, oPotatoMine, oSnowPea, oChomper, oRepeater, oPuffShroom, oSunShroom, oFumeShroom, oGraveBuster, oHypnoShroom, oScaredyShroom, oIceShroom, oDoomShroom, oLilyPad, oSquash, oThreepeater, oTangleKelp, oJalapeno, oSpikeweed, oTorchwood, oTallNut, oSeaShroom, oPlantern, oCactus, oBlover, oSplitPea, oStarfruit, oPumpkinHead, oMagnetShroom, oCabbage, oFlowerPot, oKernelPult, oCoffeeBean, oGarlic, oMelonPult, oGatlingPea, oTwinSunflower, oGloomShroom, oCattail, oWinterMelon, oSpikerock, oCobCannon,oSnowPea1,oLawnCleaner,oPoolCleaner],
	a = e.length,
	b = 0,
	c;
	while (b < a) {
