	...
	*/
	...
	AttackZombie: function(a) {
        ...
        ChangeR: function(e) {
            ...
            i = oGd.$LF,
            c; ! g.length && (d.CanPass(q, i[q]) && (g[++m] = q), d.CanPass(q += 2, i[q]) && (g[++m] = q));
            g.length ? (l = !d.WalkDirection ? -5 : 5, xyz = !d.WalkDirection ? 1 : -1, d.ZX += l, d.AttackedLX += l, d.AttackedRX += l, d.X += l,  q = g[Math.floor(Math.random() * g.length)],d.SummonX = q, SetStyle(f, {
                left: d.X + "px",
                top: (d.pixelTop = j == undefined ? GetY(q) - d.height + d.GetDY() : j) + "px",
                zIndex: d.zIndex = 3 * q + 1
            }), d.isAttacking && (n.src = d.PicArr[d.NormalGif]), oZ.moveTo(k, h, q)) : n.src = d.PicArr[d.NormalGif];
            d.isAttacking = 0;d.ResetBackupDancer(d);d.CallBack2();//console.log(d.SummonX)
        },
...
oNewspaperZombie = InheritO(OrnIIZombies, {
	...
	Produce: '他的报纸只能提供有限的防御。<p>韧性：<font color="#FF0000">中</font><br>报纸韧性：<font color="#FF0000">低</font><br>速度：正常，而后快(失去报纸后)</p><p>看到在另一个平行宇宙称霸的二爷，停</p><p>留在原时空的读报也坐不住了，终于在星</p>云的帮助下喝了药水，喝完后，他的感</p><p>言：“ I feel I become stronger!</p>,
	getShadow: function(a) {
